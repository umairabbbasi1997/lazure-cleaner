...
class NavPaths
{
  ...
  [
    ...
    ,
    GetPage(name: navCollectPayment,
        page: () => const CollectPayment()
    )
    ,
    GetPage(name: navUploadCarDetails,
        page: () => const UploadCarDetails()
    )
    ,
    GetPage(name: navVerifyAccountScreen,
